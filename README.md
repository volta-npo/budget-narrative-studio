...
# 💸 Budget Narrative Studio

### A structured builder for grant budget narratives that match numbers to purpose.
...
[Live app](https://volta-npo.github.io/15-budget-narrative-studio/) · [Report an issue](https://github.com/volta-npo/15-budget-narrative-studio/issues) · [Volta](https://voltanpo.org)
...
**Budget Narrative Studio** is a polished, local-first open-source tool from Volta's open-source program. It helps Finance students drafting budgets with mentor review turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Budget narratives are intimidating and easy to mismatch with proposal claims.

### The niche

Small grant applications under student supervision.

### North-star metric

`budget lines with clear narrative support`
...
flowchart TD
    ...
    Evidence --> Workbench["Budget Narrative Studio"]
    Workbench --> Score["Funding readiness"]
    Score --> Cert["release certification"]
    Cert --> A1["Budget CSV"]
    Cert --> A2["Budget narrative"]
    Cert --> A3["Reviewer comments report"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Line item explainer"]
        M2["Cost justification guides"]
        M3["Mismatch detector checklist"]
        M4["Reviewer comments"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Budget Narrative Studio
...
|---|---|
| **Domain workbench** | A purpose-built budget interface for a structured builder for grant budget narratives that match numbers to purpose. |
...
|---:|---|---|
| 1 | **Line item explainer** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Cost justification guides** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Mismatch detector checklist** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Reviewer comments** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
This release adds a SaaS-grade operating layer so **Budget Narrative Studio** can stand alone as more than a checklist. It models:
...
```bash
git clone https://github.com/volta-npo/15-budget-narrative-studio.git
cd 15-budget-narrative-studio
npm install
npm test
