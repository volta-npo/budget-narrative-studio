    ...
    "criteria": [
        {
            ...
            "prompt": "Implement and verify line item explainer with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "cost-justification-prompts",
            "label": "Cost justification prompts",
            "weight": 15,
            "defaultStatus": "not-started",
            "prompt": "Implement and verify cost justification prompts with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "prompt": "Implement and verify mismatch detector checklist with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "prompt": "Implement and verify reviewer comments with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "evidence-quality",
