export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Budget Narrative Studio",
        "Operational table: Budget line items",
    ...
    "releaseChecklist": [
        ...
        "Narrative Alignment reaches production threshold",
        "Math Accuracy is documented with evidence",
        "Cap Compliance has no unresolved blocker",
        "Budget CSV verified",
        "Budget narrative verified",
        "Reviewer comments report verified"
    ],
    "operations": [
